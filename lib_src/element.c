...
static int L_getTagName(lua_State *L)
{
...
static int L_getAttributeNode(lua_State *L)
{
...
static int L_setAttributeNode(lua_State *L)
{
	IXML_Attr *oldattr;
...
static int L_removeAttributeNode(lua_State *L)
{
	IXML_Attr *oldattr;
...
static int L_removeAttributeNS(lua_State *L)
{
...
static int L_getAttributeNodeNS(lua_State *L)
{
...
static int L_setAttributeNodeNS(lua_State *L)
{
	IXML_Attr *oldattr;
